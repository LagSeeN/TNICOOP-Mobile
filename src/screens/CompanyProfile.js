  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.textView}>
        ...
        <Text style={styles.textStyleInner}>{route.params.description}</Text>
        <View style={styles.lineStyle}></View>
        <Text style={styles.textStyle}>ตำแหน่งงาน</Text>
        <Text style={styles.textStyleInner}>Programmer, Software Engineer</Text>
        <View style={styles.lineStyle}></View>
        ...
        <Text style={styles.textStyleInner}>เบี้ยเลี้ยง 3,500/เดือน</Text>
      </View>
    </SafeAreaView>
  );
}
